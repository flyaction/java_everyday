...
class Test{
    ...
    public void showCars(){
        ...
        for (Car car:cars){
            if(car instanceof Truck){
                ...
                System.out.println(car.getName()+"\t\t"+car.getColor()+"\t\t"+car.setSeatNum()+"\t\t"+ truck.getWeight());
            }else{
                System.out.println(car.getName()+"\t\t"+car.getColor()+"\t\t"+car.setSeatNum()+"\t\t不能拉货");
            }
        }
    ...
    public void update(String type){
        ...
        if(type.equals("truck")){
            ...
            if(weight > 12){
                CarException carException = new CarException("开车的载重量不能超过12吨");
                try {
                    throw carException;
